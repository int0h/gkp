const {simpleDepHello} = require('simple-dep');
const {simpleOverrideHello} = require('simple-override');
const {depWithDepsHello} = require('dep-with-deps');
const {versionedHello} = require('versioned-dep');
